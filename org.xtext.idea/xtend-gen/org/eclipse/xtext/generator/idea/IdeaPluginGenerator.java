...
public class IdeaPluginGenerator extends Xtend2GeneratorFragment {
  ...
  public void generate(final Grammar grammar, final Xtend2ExecutionContext ctx) {
    ...
    String _javaPath_5 = this._ideaPluginClassNames.toJavaPath(_lexerName_1);
    CharSequence _compileLexer = this.compileLexer(grammar);
    ctx.writeFile(outlet_src_gen, _javaPath_5, _compileLexer);
    ...
    String _javaPath_7 = this._ideaPluginClassNames.toJavaPath(_parserDefinitionName);
    CharSequence _compileParserDefinition = this.compileParserDefinition(grammar);
    ctx.writeFile(outlet_src_gen, _javaPath_7, _compileParserDefinition);
    String _syntaxHighlighterName_1 = this._ideaPluginClassNames.getSyntaxHighlighterName(grammar);
    String _javaPath_8 = this._ideaPluginClassNames.toJavaPath(_syntaxHighlighterName_1);
    CharSequence _compileSyntaxHighlighter = this.compileSyntaxHighlighter(grammar);
    ctx.writeFile(outlet_src_gen, _javaPath_8, _compileSyntaxHighlighter);
  ...
  public CharSequence compileLexer(final Grammar grammar) {
    ...
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("return new InternalMyDslLexer(new ANTLRStringStream(text));");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("}");
    _builder.newLine();
