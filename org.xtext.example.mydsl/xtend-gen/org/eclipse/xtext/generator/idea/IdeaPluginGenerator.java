...
public class IdeaPluginGenerator extends Xtend2GeneratorFragment {
  ...
  public void generate(final Grammar grammar, final Xtend2ExecutionContext ctx) {
    ...
    ctx.writeFile(Generator.SRC_GEN, _tokenTypesPath, _compileTokenTypes);
  ...
  public boolean addLibrary(final String library) {
    ...
    {
      boolean _equals = Objects.equal(this.libraries, null);
      if (_equals) {
        HashSet<String> _newHashSet = CollectionLiterals.<String>newHashSet();
        this.libraries = _newHashSet;
      }
      _xblockexpression = this.libraries.add(library);
    }
  ...
  public CharSequence compileParserDefinition(final Grammar grammar) {
    ...
    _builder.append(_langPackageName, "");
    _builder.append(".");
    String _setupClassName = this._ideaPluginExtension.getSetupClassName(grammar);
    _builder.append(_setupClassName, "");
    _builder.append(";");
    _builder.newLineIfNotEmpty();
    _builder.append("import ");
    String _psiImplPackageName = this._ideaPluginExtension.getPsiImplPackageName(grammar);
    ...
    _builder.newLineIfNotEmpty();
    _builder.append("\t\t");
    String _setupClassName_1 = this._ideaPluginExtension.getSetupClassName(grammar);
    _builder.append(_setupClassName_1, "\t\t");
    _builder.append(".getInjector().injectMembers(this);");
    _builder.newLineIfNotEmpty();
    _builder.append("\t");
    _builder.append("}");
    _builder.newLine();
